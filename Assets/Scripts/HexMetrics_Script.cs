...
public static class HexMetrics_Script{
    ...
    public const float wallTowerTreshold =0.5f;

    public const float wallYOffset = -1f;
    public const float bridgeDesignLength = 7f;

    public static Color[] colors;
    static float[][] featureTresholds =
    {
    ...
    {
        float h = step * HexMetrics_Script.horizontalTerraceStepSize;
        a.x +=(b.x - a.x) * h;
        a.z += (b.z - a.z) * h;

        float v = ((step + 1) / 2) * HexMetrics_Script.verticalTerraceStepSize;
        a.y += (b.y - a.y) * v;
        return a;
    }
