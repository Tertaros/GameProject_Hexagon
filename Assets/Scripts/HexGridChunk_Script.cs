...
public class HexGridChunk_Script : MonoBehaviour
{

    HexCell_Script[] cells;
    //HexMesh_Script hexMesh;
    public HexMesh_Script terrain;
    public HexMesh_Script rivers;
    public HexMesh_Script roads;
    public HexMesh_Script water;
    public HexMesh_Script waterShore;
    public HexMesh_Script estuaries;
    ...
    private void Awake()
    {
        ...
        cells = new HexCell_Script[HexMetrics_Script.chunkSizeX * HexMetrics_Script.chunkSizeZ];
    ...
    void TriangulateEdgeTerraces(EdgeVertices begin, HexCell_Script beginCell,
                                EdgeVertices end, HexCell_Script endCell,
                                bool hasRoad)
    {

        EdgeVertices e2 = EdgeVertices.TerraceLerp(begin, end, 1);
        Color c2 = HexMetrics_Script.TerraceLerp(color1, color2, 1);
        ...
        for (int i = 2; i < HexMetrics_Script.terraceSteps; i++)
        {
            ...
            c2 = HexMetrics_Script.TerraceLerp(color1, color2, i);
    ...
    void TriangulateCornerTerraces(Vector3 begin, HexCell_Script beginCell,
                            Vector3 left, HexCell_Script leftCell,
                            Vector3 right, HexCell_Script rightCell)
    {
        Vector3 v4 = HexMetrics_Script.TerraceLerp(begin, left, 1);
        Vector3 v5 = HexMetrics_Script.TerraceLerp(begin, right, 1);
        Color c3 = HexMetrics_Script.TerraceLerp(color1, color2, 1);
        Color c4 = HexMetrics_Script.TerraceLerp(color1, color3, 1);
        ...
        for (int i = 2; i < HexMetrics_Script.terraceSteps; i++)
        {
            ...
            v4 = HexMetrics_Script.TerraceLerp(begin, left, i);
            v5 = HexMetrics_Script.TerraceLerp(begin, right, i);
            c3 = HexMetrics_Script.TerraceLerp(color1, color2, i);
            c4 = HexMetrics_Script.TerraceLerp(color1, color3, i);
    ...
    void TriangulateCornerTerracesCliff(Vector3 begin, HexCell_Script beginCell,
                                        Vector3 left, HexCell_Script leftCell,
                                        Vector3 right, HexCell_Script rightCell)
    {
        ...
        Vector3 boundary = Vector3.Lerp(HexMetrics_Script.Perturb(begin), HexMetrics_Script.Perturb(right), b);
    ...
    void TriangulateRiverQuad(Vector3 v1,Vector3 v2,Vector3 v3, Vector4 v4,
                                bool reversed, float y1,float y2,float v)
    {
        v1.y=y1;
        v2.y = y1;
        v3.y = y2;
    ...
    void TriangulateRiverQuad(Vector3 v1, Vector3 v2, Vector3 v3, Vector4 v4,
                                bool reversed, float y,float v)
    {
        TriangulateRiverQuad(v1, v2, v3, v4, reversed, y, y,v);
    }
    ...
    void TriangulateEstuary(EdgeVertices e1, EdgeVertices e2,bool incomingRiver)
    {
        ...
        estuaries.AddTriangleUV(new Vector2(0f, 0f), new Vector2(1f, 1f),
                                new Vector2(1f, 1f));
        ...
        if (incomingRiver)
        {
            ...
            estuaries.AddTriangleUV2(new Vector2(0.5f, 1.1f), new Vector2(1f, 0.8f),
                                    new Vector2(0f, 0.8f));
